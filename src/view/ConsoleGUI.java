...
public class ConsoleGUI extends JFrame {
	...
	public static ConnexionBDD connect; 
	...
	public ConsoleGUI() throws ParseException {
		...
		pnlCriteria.setBounds(10, 10, 325, 172);
		...
		btnFiltrer.setBounds(227, 140, 89, 23);
		...
		JLabel lblStade = new JLabel("Stade");
		lblStade.setBounds(15, 144, 46, 14);
		pnlCriteria.add(lblStade);
		
		JComboBox<String> choixStade = new JComboBox<String>();
		choixStade.setBounds(115, 141, 100, 20);
		pnlCriteria.add(choixStade);
		ConnexionBDD marequete = new ConnexionBDD();
		choixStade.addItem(marequete.resultat);
		

		//Définit le JScrollPane qui reçoit la JTable
		scrollPane.setBounds(10, 182, 325, 288);
		pane.add(scrollPane);
